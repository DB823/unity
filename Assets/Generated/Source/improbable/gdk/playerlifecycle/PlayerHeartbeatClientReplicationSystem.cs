...
namespace Improbable.Gdk.PlayerLifecycle
{
    public partial class PlayerHeartbeatClient
    {
        ...
        internal class ReplicationSystem : SystemBase
        {
            ...
            private ProfilerMarker foreachMarker = new ProfilerMarker("PlayerHeartbeatClientSerializationJob");
            ...
            protected override void OnUpdate()
            {
                ...
                Dependency = Entities.WithName("PlayerHeartbeatClientReplication")

...
namespace Improbable.Gdk.PlayerLifecycle
{
    public partial class PlayerHeartbeatServer
    {
        ...
        internal class ReplicationSystem : SystemBase
        {
            ...
            private ProfilerMarker foreachMarker = new ProfilerMarker("PlayerHeartbeatServerSerializationJob");
            ...
            protected override void OnUpdate()
            {
                ...
                Dependency = Entities.WithName("PlayerHeartbeatServerReplication")

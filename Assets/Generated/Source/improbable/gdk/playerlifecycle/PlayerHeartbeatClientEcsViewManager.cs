    ...
    public partial class PlayerHeartbeatClient
    {
        public class EcsViewManager : IEcsViewManager
        {
            ...
            private readonly ComponentType[] initialComponents = new ComponentType[]
            {
                ...
                ComponentType.ReadOnly<global::Improbable.Gdk.PlayerLifecycle.PlayerHeartbeatClient.HasAuthority>(),
            };
            ...
            {
                var entity = workerSystem.GetEntity(entityId);
                entityManager.RemoveComponent<global::Improbable.Gdk.PlayerLifecycle.PlayerHeartbeatClient.HasAuthority>(entity);
            ...
            private void SetAuthority(EntityId entityId, Authority authority)
            {
                switch (authority)
                {
                    ...
                    {
                        var entity = workerSystem.GetEntity(entityId);
                        entityManager.AddComponent<global::Improbable.Gdk.PlayerLifecycle.PlayerHeartbeatClient.HasAuthority>(entity);
                        break;
                    }

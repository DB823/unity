    ...
    public partial class PlayerHeartbeatServer
    {
        public class EcsViewManager : IEcsViewManager
        {
            ...
            private readonly ComponentType[] initialComponents = new ComponentType[]
            {
                ...
                ComponentType.ReadOnly<global::Improbable.Gdk.PlayerLifecycle.PlayerHeartbeatServer.HasAuthority>(),
            };
            ...
            {
                var entity = workerSystem.GetEntity(entityId);
                entityManager.RemoveComponent<global::Improbable.Gdk.PlayerLifecycle.PlayerHeartbeatServer.HasAuthority>(entity);
            ...
            private void SetAuthority(EntityId entityId, Authority authority)
            {
                switch (authority)
                {
                    ...
                    {
                        var entity = workerSystem.GetEntity(entityId);
                        entityManager.AddComponent<global::Improbable.Gdk.PlayerLifecycle.PlayerHeartbeatServer.HasAuthority>(entity);
                        break;
                    }

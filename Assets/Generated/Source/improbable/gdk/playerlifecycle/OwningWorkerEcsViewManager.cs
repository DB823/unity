    ...
    public partial class OwningWorker
    {
        public class EcsViewManager : IEcsViewManager
        {
            ...
            private readonly ComponentType[] initialComponents = new ComponentType[]
            {
                ...
                ComponentType.ReadOnly<global::Improbable.Gdk.PlayerLifecycle.OwningWorker.HasAuthority>(),
            };
            ...
            public void Clean()
            {
                var query = entityManager.CreateEntityQuery(typeof(global::Improbable.Gdk.PlayerLifecycle.OwningWorker.Component));
                var componentDataArray = query.ToComponentDataArray<global::Improbable.Gdk.PlayerLifecycle.OwningWorker.Component>(Allocator.TempJob);
            ...
            {
                var entity = workerSystem.GetEntity(entityId);
                entityManager.RemoveComponent<global::Improbable.Gdk.PlayerLifecycle.OwningWorker.HasAuthority>(entity);
            ...
            private void SetAuthority(EntityId entityId, Authority authority)
            {
                switch (authority)
                {
                    ...
                    {
                        var entity = workerSystem.GetEntity(entityId);
                        entityManager.AddComponent<global::Improbable.Gdk.PlayerLifecycle.OwningWorker.HasAuthority>(entity);
                        break;
                    }

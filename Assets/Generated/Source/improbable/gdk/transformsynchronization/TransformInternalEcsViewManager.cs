    ...
    public partial class TransformInternal
    {
        public class EcsViewManager : IEcsViewManager
        {
            ...
            private readonly ComponentType[] initialComponents = new ComponentType[]
            {
                ...
                ComponentType.ReadOnly<global::Improbable.Gdk.TransformSynchronization.TransformInternal.HasAuthority>(),
            };
            ...
            {
                var entity = workerSystem.GetEntity(entityId);
                entityManager.RemoveComponent<global::Improbable.Gdk.TransformSynchronization.TransformInternal.HasAuthority>(entity);
            ...
            private void SetAuthority(EntityId entityId, Authority authority)
            {
                switch (authority)
                {
                    ...
                    {
                        var entity = workerSystem.GetEntity(entityId);
                        entityManager.AddComponent<global::Improbable.Gdk.TransformSynchronization.TransformInternal.HasAuthority>(entity);
                        break;
                    }

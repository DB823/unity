    ...
    public partial class Persistence
    {
        public class EcsViewManager : IEcsViewManager
        {
            ...
            private readonly ComponentType[] initialComponents = new ComponentType[]
            {
                ...
                ComponentType.ReadOnly<global::Improbable.Persistence.HasAuthority>(),
            };
            ...
            {
                var entity = workerSystem.GetEntity(entityId);
                entityManager.RemoveComponent<global::Improbable.Persistence.HasAuthority>(entity);
            ...
            private void SetAuthority(EntityId entityId, Authority authority)
            {
                switch (authority)
                {
                    ...
                    {
                        var entity = workerSystem.GetEntity(entityId);
                        entityManager.AddComponent<global::Improbable.Persistence.HasAuthority>(entity);
                        break;
                    }

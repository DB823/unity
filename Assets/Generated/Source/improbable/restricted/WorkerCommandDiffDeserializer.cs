...
namespace Improbable.Restricted
{
    ...
    {
        private class DisconnectDiffCommandDeserializer : ICommandDiffDeserializer
        {
            ...
            public void AddResponseToDiff(CommandResponseOp op, ViewDiff diff, CommandMetaData commandMetaData)
            {
                ...
                var commandContext = commandMetaData.GetContext<global::Improbable.Restricted.DisconnectRequest>(ComponentId, 1, internalRequestId);
        ...
        private class DisconnectCommandSerializer : ICommandSerializer
        {
